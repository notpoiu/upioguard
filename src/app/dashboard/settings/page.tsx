              ...
              <TabsContent value="account">
                <Card className="mt-5">
                  <CardHeader>
                    ...
                    <CardDescription>The linked discord username of your account</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="mt-5">
                  <CardHeader>
                    ...
                    <CardDescription>The linked email from discord (hover to reveal)</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="blur-sm hover:blur-none transition-all">{session?.user?.email}</p>
                  </CardContent>
                </Card>
                ...
                <Card className="mt-5 min-h-[8rem]">
                  <CardHeader className="relative">
                    ...
                    <CardDescription>This is your avatar from discord</CardDescription>
